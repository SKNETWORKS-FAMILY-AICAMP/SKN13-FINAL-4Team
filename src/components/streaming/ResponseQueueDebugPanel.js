...
const ResponseQueueDebugPanel = ({ detailedQueueInfo, queueStatus, isMinimized = false }) => {
    ...
    if (isMinimized) {
        ...
        const failedHistory = recentHistory.filter(item => item.status === 'failed' || item.status === 'cancelled');
            ...
            <div className="mt-2 p-2 bg-info bg-opacity-10 rounded">
                <div className="d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        ...
                        <span className="badge bg-danger me-2">{failedHistory.length} 실패</span>
            ...
            <div className="mb-3">
                ...
                {recentHistory.length > 0 ? (
                    ...
                    <div className="text-center py-2">
                        <span className="text-muted small">처리 이력이 없습니다</span>
                    </div>
                )}
            </div>
